...
export default function Properties() {
  ...
  // Price filter - commented out for future use
  // const [priceFilter, setPriceFilter] = useState("all")
  const [priceFilter] = useState("all") // Keep for compatibility but don't use
  ...
  useEffect(() => {
    fetchProperties()
  }, [/* priceFilter, */ areaFilter, propertyTypeFilter, transactionTypeFilter])
  ...
  const fetchProperties = async () => {
    try {
      ...
      // Price filter logic - commented out for future use
      // if (priceFilter !== "all") {
      //   if (priceFilter === "under5") {
      //     params.maxPrice = 5000000
      //   } else if (priceFilter === "5to8") {
      //     params.minPrice = 5000000
      //     params.maxPrice = 8000000
      //   } else if (priceFilter === "over8") {
      //     params.minPrice = 8000000
      //   }
      // }
  ...
  useEffect(() => {
    setCurrentPage(1)
  }, [searchTerm, /* priceFilter, */ areaFilter, propertyTypeFilter, transactionTypeFilter])
    ...
    <main className="min-h-screen">
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <Popover open={isFilterOpen} onOpenChange={setIsFilterOpen}>
              <PopoverTrigger asChild>
                <Button
                  variant="outline"
                  className="relative px-4 py-2.5 sm:py-2 gap-2"
                >
              ...
              <PopoverContent 
                className="w-[calc(100vw-2rem)] sm:w-96 max-h-[85vh] overflow-y-auto" 
                align="end"
                side="bottom"
                sideOffset={8}
                collisionPadding={16}
                ...
                <div className="space-y-4">
                  ...
                  {/* <div className="space-y-2">
                    ...
                    >
                      ...
                      <option value="under5">Under ₹5Cr</option>
                      <option value="5to8">₹5Cr - ₹8Cr</option>
                      <option value="over8">Over ₹8Cr</option>
                    </select>
                  </div> */}
                </div>
              </PopoverContent>
      ...
      <section className="py-20 md:py-32">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <Link key={property._id} href={`/properties/${property._id}`}>
                  ...
                  >
                    <div className="relative h-64 rounded-xl overflow-hidden mb-4">
                      <img
                        src={property.displayImage?.url || "/placeholder.svg"}
                        alt={property.title}
            ...
            >
              ...
              {Array.from({ length: totalPages }, (_, i) => i + 1).map((page) => {
                ...
                if (
                  ...
                  return (
                    <span key={page} className="px-2 text-foreground/50">
                      ...
                    </span>
                  )
                }
          ...
          {filteredProperties.length > 0 && (
            <motion.div
              className="text-center mt-6 text-foreground/70"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
