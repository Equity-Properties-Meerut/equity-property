        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <img src="/luxury-office-interior.jpg" alt="Equity Properties Meerut office interior showcasing luxury real estate services" className="w-full h-full object-cover" />
            </motion.div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
            ...
            >
              <img
                ...
                alt="Equity Properties Meerut logo - Premium real estate services in Meerut"
